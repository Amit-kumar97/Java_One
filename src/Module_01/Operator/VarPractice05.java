...
/*
    ...
    There is no input for this task. The function should return the floored integer average value. For example, given the above ratings, the function should return 11." Note

    In JavaScript, you can use the Math.floor() function to get the floored integer value.
...
public class VarPractice05 {
    public static void main(String[] args) {
        ...
        int avg = (int)(rating1+rating2+rating3)/3;
