...
/*
    ...
    Note
    You do not have to worry about classes and objects for now; just keep that abstract. We will cover everything related to
    classes and objects in Module 2. For the time being, understand the syntax only. This is only shown to you so that you
    can be able to complete the function of the question given to you in the contest; otherwise, there is no need to create
    a different class to solve the questions using the function.
 */
